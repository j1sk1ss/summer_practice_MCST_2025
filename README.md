...
### Описание решения
За основу был взят алгоритм сортировки "быстрая сортировка". Перед сортировкой, входная последовательность разбивается на чанки, кол-во которых равно кол-ву возможных потоков. Каждый такой чанк проходит сортировку, после чего происходит слияние, алгоритм которого подробно описан в файле `sorter.c`. </br>
